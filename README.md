...
**Principal Data Scientist (Contract)**
...
* Developed a lightweight YOLO inferencing API that auto-discovers `.pt` models and exposes unified JSON endpoints for detection, classification, segmentation, and oriented bounding-box use cases.
* Created a config-driven YOLO training pipeline using Azure Blob Storage, Azure ML dataset registration, cloud training jobs, and MLflow experiment tracking.

## Global Initiative Against Transnational Organized Crime

**Fractional CTO / Principal Data Scientist (Contract)**
...
**Software Engineer / Software Architect / Data Scientist**
*UK & Remote*
**Prior to 2015**
